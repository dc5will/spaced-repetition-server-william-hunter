...
describe('User Endpoints', function () {
  ...
  describe(`POST /api/user`, () => {
    ...
    describe(`Given a valid user`, () => {
      ...
      //       { original: 'goodbye', translation: 'casa' },
      //       { original: 'good', translation: 'adios' },
      //       { original: 'where', translation: 'donde' },
      //       { original: 'amazing', translation: 'increible' },
      //       { original: 'dog', translation: 'perro' },
      //       { original: 'cat', translation: 'gato' },
      //       { original: 'mister', translation: 'senor' },
      //       { original: 'time', translation: 'tiempo' },
      //       { original: 'who', translation: 'quien' },
      //       { original: 'beer', translation: 'cerveza' },
      //       { original: 'coffee', translation: 'cafe' },
      //       { original: 'kitchen', translation: 'cocina' },
      //       { original: 'computer', translation: 'ordernador' },
      //       { original: 'now', translation: 'ahora' },
      //       { original: 'tomorrow', translation: 'manana' },
      //       { original: 'thanks', translation: 'gracias' },
      //       { original: 'shoe', translation: 'zapato' },
      //       { original: 'last', translation: 'ultimo' },
      //     ],
      //   };
      //   return supertest(app)
      //     .post('/api/user')
